...
export default function ToDo({todo, setCompleted, remove}:{todo:ToDoType, setCompleted:(id:number)=>void, remove:(id:number)=>void}) {
    ...
    return (
        <div className="bg-Very-Dark-Desaturated-Blue flex justify-between items-center gap-3 p-3 rounded-sm w-[550px] max-h-fit text-Light-Grayish-Blue border-b border-b-Very-Dark-Grayish-Blue">
